# DisplayName: Jolla ido/@ARCH@ (release) 1
...
repo --name=adaptation0-ido-@RELEASE@ --baseurl=https://store-repository.jolla.com/releases/@RELEASE@/jolla-hw/adaptation-xiaomi-ido/@ARCH@/
...
%packages
@Jolla Configuration ido
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/ido
